      ...
      <main className='container mx-auto py-8 px-4 font-exo relative'>
        <div className='fixed bottom-4 right-4 z-50'>
          <Button
            ...
            variant='outline'
            size='icon'
            aria-description='subir del todo'
            className='rounded-full bg-primary text-gray-sipan shadow-md'
          >
            <ArrowUpIcon className='w-4 h-2' />
          </Button>
        </div>
        ...
        <Card className='mb-8'>
          ...
          <CardContent>
            ...
            <p className='mb-4'>
              ...
              Este servicio está diseñado con fines académicos y de
              investigación.
            </p>
            ...
            <p className='mb-4'>
              ...
              verificar manualmente todas las fuentes y la información obtenida
              a través de SipánGPT.
            </p>
            ...
            <p className='mb-4'>
              La Universidad Señor de Sipán ha otorgado su consentimiento para
              el uso de su nombre en este proyecto, pero no está involucrada en
              el desarrollo, mantenimiento o operación de SipánGPT. La
              Universidad Señor de Sipán queda exenta de cualquier
              responsabilidad relacionada con el uso, funcionamiento o
              consecuencias derivadas de SipánGPT.
            </p>
            ...
            <p className='mb-4'>
              ...
              momento. Le notificaremos cualquier cambio significativo por
              correo electrónico. El uso continuado de SipánGPT después de
        ...
        <Card className='mb-8'>
          ...
          <CardContent>
            ...
            <p className='mb-4'>
              ...
              directamente, como nombre de usuario y datos de las
              conversaciones. Esta información se utiliza únicamente para fines
              propios y académicos, y no se comparte con terceros.
            </p>
            ...
            <p className='mb-4'>
              ...
              SipánGPT y para fines de investigación académica. No compartimos
              sus datos personales con terceros sin su consentimiento explícito,
            ...
            <p className='mb-4'>
              ...
              en cualquier momento. Cualquier cambio significativo será
              notificado a través de su correo electrónico registrado.
            </p>
          </CardContent>
        </Card>
